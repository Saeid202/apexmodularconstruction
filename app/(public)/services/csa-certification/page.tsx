...
import { Section, SectionHeader, SectionEyebrow, SectionHeading, SectionSubheading } from "@/components/ui/Section";
  ...
  return (
    <>
      ...
      <main>
        ...
        {/* HERO */}
        <section aria-label="Hero" className="relative overflow-hidden py-28 px-6 bg-gradient-primary">
          <img
          ...
          <div className="relative max-w-4xl mx-auto text-center">
            <div className="inline-flex h-16 w-16 items-center justify-center rounded-2xl mb-6 bg-secondary-500 shadow-elevation-high">
            ...
            <h1 className="text-4xl md:text-5xl lg:text-6xl font-extrabold text-white mb-5 leading-tight tracking-tight">
              ...
              <span className="text-secondary-500"> Prefab Buildings in Canada</span>
            </h1>
            ...
            <div className="flex flex-wrap items-center justify-center gap-4">
              <Link
                ...
                className="inline-flex items-center gap-2 rounded-xl bg-secondary-500 text-primary-900 px-6 py-3.5 text-base font-bold transition-all hover:opacity-90 shadow-elevation-medium"
              >
              ...
              <Link
                ...
                className="inline-flex items-center gap-2 rounded-xl px-6 py-3.5 text-base font-bold text-white border-2 border-white/50 transition-all hover:bg-white/10"
              >
                <span className="text-white">View Construction Solutions</span>
                <ChevronRight className="h-4 w-4" />
              </Link>
            </div>
          </div>
        ...
        <section
          ...
          className="border-b border-secondary-500/20 bg-muted/50"
        >
        ...
        <Section ariaLabelledby="what-is-csa" background="white">
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div>
              <SectionHeader eyebrow="The Basics" heading={<span id="what-is-csa">What Is CSA Certification?</span>} />
              <div className="mt-6 space-y-4 text-muted-foreground leading-relaxed">
                <p>
                  CSA stands for <strong className="text-foreground">Canadian Standards Association</strong>.
                ...
                <p>
                  When a product carries a CSA mark, it means an accredited body has tested and verified that
                  it meets Canadian safety and performance requirements. For construction projects, this matters
                  at every stage — from building permits to final inspections.
                </p>
                <p>
                  For prefab buildings imported from China, CSA certification is the primary mechanism for
                  demonstrating that overseas-manufactured components meet Canadian standards. Without it,
                  projects face permit delays, failed inspections, and costly rework.
                </p>
              </div>
              ...
              <div className="mt-8">
                <Link
                  href="/services/construction-solutions"
                  className="inline-flex items-center gap-2 text-sm font-bold text-primary transition-colors hover:opacity-80"
                >
                  <ChevronRight className="h-4 w-4" />
            ...
            <div className="grid grid-cols-2 gap-4">
              {[
                ...
                <div
                  key={label}
                  className="rounded-2xl p-5 text-center bg-gradient-to-br from-primary/[0.03] to-secondary-500/[0.03] border border-secondary-500/25 shadow-elevation-low"
                >
                  <p className="text-2xl font-extrabold mb-1 text-primary">{value}</p>
        ...
        <Section ariaLabelledby="when-required" background="muted">
          <SectionHeader
            center
            eyebrow="Requirements"
            heading={<span id="when-required">When Is CSA Certification Required?</span>}
            subheading="Requirements vary by component type and jurisdiction. Here is a practical breakdown."
          />
        ...
        <Section ariaLabelledby="how-to-comply" background="white">
          <SectionHeader
            center
            eyebrow="Compliance Pathway"
            heading={<span id="how-to-comply">How Prefab from China Can Meet Canadian Standards</span>}
            subheading="There are three main pathways. The right one depends on your project type and timeline."
          />
          ...
          <div className="space-y-5">
            {[
              ...
              <div
                key={number}
                className="rounded-2xl bg-background p-7 flex gap-6 border border-primary/10 shadow-elevation-low"
              >
                ...
                <div className="flex-1">
                  ...
                  <span className="text-xs font-bold rounded-lg px-3 py-1.5 inline-block bg-primary/10 text-primary">
                    → {tag}
                  </span>
                </div>
              </div>
        ...
        <Section ariaLabelledby="common-mistakes" background="muted">
          <SectionHeader
            center
            eyebrow="What Goes Wrong"
            heading={<span id="common-mistakes">Common CSA Compliance Mistakes</span>}
            subheading="These are the mistakes that cause permit failures, stop-work orders, and expensive rework. Most are avoidable with early planning."
          />
          ...
          <div className="grid sm:grid-cols-2 gap-5">
            {[
              ...
              <div
                key={title}
                className="rounded-2xl bg-background p-6 flex gap-4 border border-red-200 shadow-elevation-low"
              >
                <AlertTriangle className="h-5 w-5 shrink-0 mt-0.5 text-red-500" />
                <div>
                  <h3 className="text-sm font-extrabold text-foreground mb-1.5">{title}</h3>
                  <p className="text-sm text-muted-foreground leading-relaxed">{body}</p>
                </div>
              </div>
            ))}
        ...
        <Section ariaLabelledby="approval-process" background="white">
          <SectionHeader
            center
            eyebrow="Step by Step"
            heading={<span id="approval-process">The CSA Approval Process</span>}
            subheading="From project start to permit approval — what happens at each stage."
          />
        ...
        <Section ariaLabelledby="compliance-cost" background="muted">
          <SectionHeader
            center
            eyebrow="Cost Reference"
            heading={<span id="compliance-cost">Cost of CSA Compliance</span>}
            subheading={
              <>
          ...
          <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-5 mb-12">
            ...
            ].map(({ label, range, note, isGold }) => (
              <div
                key={label}
                className={`rounded-2xl p-6 border border-secondary-500/20 ${
                  isGold ? "bg-amber-50/80" : "bg-primary/[0.03]"
                }`}
              >
                <p className="text-xs font-bold uppercase tracking-wide text-muted-foreground mb-2">{label}</p>
                <p className="text-2xl font-extrabold mb-1 text-primary">{range}</p>
                <p className="text-xs text-muted-foreground leading-relaxed">{note}</p>
              </div>
            ))}
          </div>

          <div className="rounded-2xl p-6 flex gap-4 bg-primary/[0.06] border border-primary/20">
            <CheckCircle className="h-5 w-5 shrink-0 mt-0.5 text-primary" />
            <p className="text-sm text-muted-foreground leading-relaxed">
              <strong className="text-foreground">Key insight:</strong> Compliance costs of 3–8%
              are almost offset by the 20–40% savings from Chinese manufacturing. The net
        ...
        <Section ariaLabelledby="estimate-form-heading" background="white">
          <div className="max-w-2xl mx-auto">
            <SectionHeader
              center
              eyebrow="Free Estimate"
              heading={<span id="estimate-form-heading">Get a Project Cost Estimate</span>}
              subheading="Tell us about your project and we'll provide a cost estimate that includes both manufacturing and compliance costs."
            />
        ...
        <section
          ...
          className="py-24 px-6 relative overflow-hidden bg-gradient-primary"
        >
          <img
          ...
          <div className="relative max-w-3xl mx-auto text-center">
            ...
            <p className="text-sm text-purple-300 mb-10">
              ...
              <Link
                href="/services/construction-solutions"
                className="font-bold underline text-secondary-500 hover:opacity-80"
              >
            ...
            <div className="flex flex-wrap items-center justify-center gap-4">
              <Link
                href="/contact?subject=CSA Compliance Consultation"
                className="inline-flex items-center gap-2 rounded-xl px-7 py-4 text-base font-bold bg-secondary-500 text-primary-900 transition-all hover:opacity-90 shadow-elevation-medium"
              >
              ...
              <Link
                href="/services/construction-solutions"
                className="inline-flex items-center gap-2 rounded-xl px-7 py-4 text-base font-bold text-white border-2 border-white/50 transition-all hover:bg-white/10"
              >
