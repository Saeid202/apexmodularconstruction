...
-- 2. Zoning Polygons Table
CREATE TABLE IF NOT EXISTS zoning_polygons (
    id SERIAL PRIMARY KEY,
    objectid INTEGER UNIQUE,
    zn_zone VARCHAR(50) NOT NULL,
    zn_string VARCHAR(255),
...
-- 3. Zone Standards Table
CREATE TABLE IF NOT EXISTS zone_standards (
    id SERIAL PRIMARY KEY,
    zone_code VARCHAR(50) UNIQUE NOT NULL,
    zone_type VARCHAR(100) NOT NULL,
    max_height DOUBLE PRECISION,
    max_fsi DOUBLE PRECISION,
    max_coverage DOUBLE PRECISION,
    min_frontage DOUBLE PRECISION,
    min_setback_front DOUBLE PRECISION,
    min_setback_rear DOUBLE PRECISION,
    min_setback_side DOUBLE PRECISION,
    created_at TIMESTAMPTZ DEFAULT now()
);
...
-- 6. Zoning Exception Overrides Table
...
-- 8. Heritage Properties Registry Table
...
-- 9. Test Address Ground Truth Table
...
-- Seed base zone standards for residential zones RD and R
