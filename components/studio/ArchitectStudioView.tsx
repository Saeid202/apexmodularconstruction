 ...
 * changes. The custom page (Page Builder) is rendered between the branded
 * header and footer when the architect has built one.
 */
...
export function ArchitectStudioView({ profile }: { profile: any }) {
