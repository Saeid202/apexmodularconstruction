...
export function WhatsAppButton() {
  function handleClick(e: React.MouseEvent<HTMLAnchorElement>) {
    ...
    window.location.href = "whatsapp://send?phone=12898168314&text=Hi%20Apex Modular Construction%2C%20I%20have%20a%20question.";
    // Fall back to wa.me after a short delay if app didn't open
    setTimeout(() => {
      window.open(
        "https://wa.me/12898168314?text=Hi%20Apex Modular Construction%2C%20I%20have%20a%20question.",
        "_blank"
      );
    }, 1000);
  }
  ...
  return (
    <a
      href="whatsapp://send?phone=12898168314&text=Hi%20Apex Modular Construction%2C%20I%20have%20a%20question."
      onClick={handleClick}
